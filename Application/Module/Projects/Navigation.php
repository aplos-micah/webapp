...
<li class="side-nav__group"><span>Projects</span></li>

<li>
    <a href="/projects/dashboard"
       class="side-nav__link<?= $currentSlug === 'projects/dashboard' ? ' is-active' : '' ?>">
...
<li>
    <a href="/projects/projects/list"
       class="side-nav__link<?= str_starts_with($currentSlug, 'projects/projects') ? ' is-active' : '' ?>">
...
<li>
    <a href="/projects/guide"
       class="side-nav__link<?= $currentSlug === 'projects/guide' ? ' is-active' : '' ?>">
