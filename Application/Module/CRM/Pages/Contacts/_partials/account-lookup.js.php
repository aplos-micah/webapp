...
(function () {
    function initLookup(widget) {
        const input   = widget.querySelector('.account-lookup__input');
        const hidden  = widget.querySelector('.account-lookup__value');
        const results = widget.querySelector('.account-lookup__results');

        // Pre-populate text field if an account is already selected
        ...
        function getOptions() {
            return [...results.querySelectorAll('.account-lookup__option')];
        }
        ...
        input.addEventListener('blur', function () {
            // Short delay so mousedown on option can fire first
