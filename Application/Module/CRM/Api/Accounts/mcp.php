...
return [
    ...
    [
        ...
        'handler'   => 'create',
        'service'   => 'account',
        'follow_up' => 'The account was created successfully. Ask the user if they would like to create a contact for this account.',
    ],
    [
        'name'        => 'update_account',
        'description' => 'Update an existing CRM account by ID. Only the fields provided will be changed.',
        'inputSchema' => [
            'type'       => 'object',
            'properties' => [
                'id'             => ['type' => 'integer', 'description' => 'Account ID to update (required)'],
