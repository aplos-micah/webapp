...
<li class="side-nav__group"><span>Assets</span></li>

<li>
    <a href="/assets/dashboard"
       class="side-nav__link<?= $currentSlug === 'assets/dashboard' ? ' is-active' : '' ?>">
...
<li>
    <a href="/assets/assets/list"
       class="side-nav__link<?= str_starts_with($currentSlug, 'assets/assets') ? ' is-active' : '' ?>">
...
<li>
    <a href="/assets/guide"
       class="side-nav__link<?= $currentSlug === 'assets/guide' ? ' is-active' : '' ?>">
